...
$CONSULTA = $conn->prepare("SELECT id_do_pedido, itens, valor_UNITARIO, quant_sub, subtotal, total, data_e_hora, nome_sob_cliente, tel_de_cont, endereco, proximo, cep, origem FROM pedidos GROUP BY id_do_pedido ORDER BY data_e_hora ASC");
