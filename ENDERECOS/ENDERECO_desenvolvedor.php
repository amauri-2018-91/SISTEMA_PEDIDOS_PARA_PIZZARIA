...
<html lang="pt-br"><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"> <title> Desenvolvedor</title> <link href="../css/bootstrap.min.css" rel="stylesheet">
...
<h1 class="tipoprduto_h1" > Endereço do Desenvolvedor deste site:  </h1>
...
<div class="container rodape"><div class="row"><div class="col-xs-12 col"> <p id="pizzariaanapaula">Procurar por Amauri : </p><p id="telefones">FONES: ????-???? / Whats: ????-????  </p> <h1 class="tipoprduto_h1" >AV. ???????, NUM - ??????? -?????????????????????  <span class="glyphicon glyphicon-map-marker"></span>  </h1>
   <a class="botaoh1" href="ENDERECO_PIZZARIA.php" > <h1>Veja : Endereço da Pizzaria <span class="glyphicon glyphicon-map-marker"></span>  </h1> </a>
</div></div></div>
